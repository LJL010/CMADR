...
def generate_train_queries(num_entries):
    ...
    for _ in range(num_entries):
        query = {
            "src": generate_random_number(0, 260),
            "dst": generate_random_number(0, 260),
            "time": generate_random_number(0, 5736)
        }
...
def generate_json_data():
    data = {
        "train_queries": generate_train_queries(6000),
        "predict_queries": generate_predict_queries(6000)
    }
    return data
